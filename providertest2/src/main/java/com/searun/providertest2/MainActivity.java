package com.searun.providertest2;
    ...
    public void onClick(View v) {
        switch (v.getId()){
            case R.id.add:
                ...
                values.put(Persons.COLUMN_NAME,"张三");
                values.put(Persons.COLUMN_PHONE,"999999");
            ...
            case R.id.update:
                ...
                values1.put(Persons.COLUMN_NAME,"李四");
                values1.put(Persons.COLUMN_PHONE,"55555");
