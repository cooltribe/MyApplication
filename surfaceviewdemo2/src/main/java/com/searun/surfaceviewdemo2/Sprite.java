...
public class Sprite {
    ...
    public Sprite(int positionX, int positionY, int width, int height, double speed, FrameAnimation[] frameAnimations) {
        this.x = positionX;
        this.y = positionY;
        this.width = width;
        this.height = height;
    ...
    public void setDirection(){
        ...
        } else if (this.y + this.height >= GameSurfaceView.SCREEN_HEIGHT && this.x + this.width < GameSurfaceView.SCREEN_WIDTH){
        ...
        } else if (this.x + this.width >= GameSurfaceView.SCREEN_WIDTH && this.y > 0){
